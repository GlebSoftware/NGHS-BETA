...
if (isset($_GET['year'])) {
  $colname_memberPoints = $_GET['year'];
}
mysql_select_db($database_nghsbeta, $nghsbeta);
$query_memberPoints = sprintf("SELECT * FROM VWmemberPoints WHERE `year` = %s ORDER BY stuID ASC", GetSQLValueString($colname_memberPoints, "text"));
