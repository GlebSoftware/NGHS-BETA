...
<body style="background:#fff; max-width:1000px; padding:50px;">
	...
	<h1>Beta Officer Applications</h1>
	
<?php do { ?>
  		<h1><?php echo $row_officerApplications['studentName']; ?></h1>
  		Student ID: <strong><?php echo $row_officerApplications['studentID']; ?></strong><br />
  		Email: <strong><?php echo $row_officerApplications['studentEmail']; ?></strong><br />
  		Phone: <strong><?php echo $row_officerApplications['studentPhone']; ?></strong><br />
  		<br />
  		Position Running For: <strong><?php echo $row_officerApplications['position']; ?></strong><br />
  		<br />
  		<?php echo $row_officerApplications['shortAnswer']; ?></strong>
<?php } while ($row_officerApplications = mysql_fetch_assoc($officerApplications)); ?>
</body>
</html>
<?php
