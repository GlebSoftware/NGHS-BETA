...
if($_POST['submit']=='Login')
{
	...
	if(!count($err))
	{
		...
		$row = mysql_fetch_assoc(mysql_query("SELECT id,stuID FROM beta_members WHERE stuID='{$_POST['username']}'"));
...
else if($_POST['submit']=='Register')
{
	...
	if(!count($err))
	{
		...
		mysql_query("	INSERT INTO beta_members(usr,pass,email,regIP,dt)
						VALUES(
		...
		<div class="content clearfix">
			...
			<div class="left">
				...
				<form class="clearfix" action="" method="post">
					...
					<label class="grey" for="username">Student ID:</label>
